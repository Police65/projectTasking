          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'Main_tracker')
                  : const MainTrackerWidget(),
            ),
            FFRoute(
              name: 'createTask_1_SelectProject',
              path: 'createTask1SelectProject',
              requireAuth: true,
              builder: (context, params) => const CreateTask1SelectProjectWidget(),
            ),
            FFRoute(
              name: 'createTask',
              path: 'createTask',
            ...
            FFRoute(
              ...
              path: 'addTeamMembers',
              requireAuth: true,
              builder: (context, params) => const AddTeamMembersWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              ...
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'Main_projectsWeb')
                  : const MainProjectsWebWidget(),
            ),
            FFRoute(
              name: 'Main_teamPage',
              path: 'mainTeamPage',
              requireAuth: true,
              builder: (context, params) => params.isEmpty
                  ? const NavBarPage(initialPage: 'Main_teamPage')
                  : const MainTeamPageWidget(),
            ),
            FFRoute(
              name: 'Main_projects',
              path: 'mainProjects',
              builder: (context, params) => const MainProjectsWidget(),
            ),
            FFRoute(
              name: 'myProfile',
              path: 'myProfile',
